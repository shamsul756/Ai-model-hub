        ...
        <div>
          ...
          <div className="card w-full bg-base-100 shadow-xl border border-gray-300">
            <div className="card-body relative flex gap-5">
              ...
              {/* feature style end  */}
              <div className="mt-6">
                <button onClick={handleBuyNow} className="bg-gradient-to-r from-[#4b19fd] to-[#3051e1] btn btn-primary btn-block text-2xl rounded-full h-[60px]">{isBuy ? "Buy Now" : "Buy"}</button>
              </div>
            </div>
          </div>
          {/* card design end  */}
