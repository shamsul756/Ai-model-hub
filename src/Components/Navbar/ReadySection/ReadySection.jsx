    ...
    return (
        <div className='bg-gradient-to-r from-[#433799] to-[#6d0fdf] py-[100px]'>
            <div className='container mx-auto'>
                ...
                <div className='flex flex-col space-y-3 md:flex-row md:space-y-0 md:gap-3 justify-center items-center p-2'>
                    <button className="border bg-white transition-all px-7 py-2 rounded-[50px] font-semibold text-2xl shadow-cyan-500/30 flex items-center group text-[#4f39f6] cursor-pointer">
                        View Pricing
                    </button>
                    <button className="border border-white px-6 py-2 rounded-[50px] font-semibold text-2xl flex items-center group text-white">
                        Explore Products
                    </button>
                </div>
