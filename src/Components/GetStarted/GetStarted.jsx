        ...
        <div className='container mx-auto px-4 py-10'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-xl p-6 relative">
                    ...
                    <h3 className="text-gray-800 font-bold text-xl mt-3 mb-2">Create Account</h3>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-xl p-6 relative">
                    ...
                    <h3 className="text-gray-800 font-bold text-xl mt-3 mb-2">Choose a Plan</h3>
                    <p className="text-gray-500 text-sm">
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-xl p-6 relative">
                    ...
                    <h3 className="text-gray-800 font-bold text-xl mt-3 mb-2">Start Using AI</h3>
